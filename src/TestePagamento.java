...
public class TestePagamento {
    ...
    public static void main(String[] args) {
        ...
        ((ArrayList<?>) ingressos).add(new Ingresso(evento, 100.00));

        Pedido pedido = new Pedido(1, cliente, evento, ingressos, 1);

        Pagamento pagamento = new Pagamento(1, LocalDate.now(), 100.00, pedido);

        System.out.println(pagamento.consultarPagamento(1)); // true

        pagamento.gerarImpressaoPagamento();
    }
}
